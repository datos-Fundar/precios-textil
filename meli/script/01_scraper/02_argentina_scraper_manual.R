...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('02_argentina_scraper_manual ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('02_argentina_scraper_manual ',Sys.Date(),'.rds')))
...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('13_uruguay_scraper_manual_tiendas_oficiales ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('13_uruguay_scraper_manual_tiendas_oficiales ',Sys.Date(),'.rds')))

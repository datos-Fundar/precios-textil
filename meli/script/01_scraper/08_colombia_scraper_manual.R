...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('08_colombia_scraper_manual ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('08_colombia_scraper_manual ',Sys.Date(),'.rds')))

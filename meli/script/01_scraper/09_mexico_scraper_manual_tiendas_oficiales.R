...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('09_mexico_scraper_manual_tiendas_oficiales ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('09_mexico_scraper_manual_tiendas_oficiales ',Sys.Date(),'.rds')))
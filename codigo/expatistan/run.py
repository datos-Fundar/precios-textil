...
import os
import scraper
from scraper import countries, item2custom_category
...
if __name__ == '__main__':
    ...
    df = scraper.get_expatistan_data(country_list=countries.to_list(), cat_prop = cat_prop, mapper = item2custom_category)

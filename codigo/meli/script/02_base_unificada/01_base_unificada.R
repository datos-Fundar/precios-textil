...
# Rutas 
instub <- 'precios-textil/codigo/meli/input/raw/'
outstub <- 'precios-textil/codigo/meli/input/base/'
...
data.table::fwrite(data_final,file.path(outstub,'base_unificada.csv'))
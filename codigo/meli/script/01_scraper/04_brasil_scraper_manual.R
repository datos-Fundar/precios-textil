...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('04_brasil_scraper_manual ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('04_brasil_scraper_manual ',Sys.Date(),'.rds')))
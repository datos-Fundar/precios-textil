...
urls <- 'https://www.mercadolibre.com.co/'
...
for(i in 1:length(productos$categoria)){
  ...
  # Ir a la web 
  remote_driver$navigate('https://www.mercadolibre.com.co/')
...
# Guardar csv 
write_csv(data_final,file.path(outstub,paste0('07_colombia_scraper_manual_tiendas_oficiales ',Sys.Date(),'.csv')))
saveRDS(data_final,file.path(outstub,paste0('07_colombia_scraper_manual_tiendas_oficiales ',Sys.Date(),'.rds')))
